                            ...
                            if (err === null) {
                                if (res1 === null) {
                                    ...
                                    if (checkValid > timeNow) {
                                        ...
                                        otpcol.update({"phone": encryptedPhone2.toString('utf-8')}, {$set: {"phone": encryptedPhone2.toString(),"otp": otpcode1,"valid":new Date().getTime() + 15 * 60 * 1000}}, function (err, resnew) {
                                            if (err === null) {
